...
необязательные язык и длительность допускают `null`, пожелания — пустую строку.
Дата: ISO `YYYY-MM-DD`, диапазон 23.09.2026–31.12.2026; длительность: 1–12 часов;
бюджет: целое число 100000–1000000000 ₸. Агент должен уточнять неизвестные обязательные
