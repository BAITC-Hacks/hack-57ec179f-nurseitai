...
Инструмент возвращает максимум три рекомендации и полное число подходящих в `matched_count`.
Сравнение и shortlist используют эти рекомендации; дополнительные карточки не раскрываются.
...
`data/related_categories.json`. Приложение не вызывает API бронирования или отправки
сообщений.
